...
<p>This gets similar result as the typical .col-md-10 .col-md-offset-1 from Bootstrap, specially in desktop, and can be used indenpendently, not need to be nested inside a <code>.container</code>. </p>
