...
<p>
  This gets similar result as the typical .col-md-10 .col-md-offset-1 from Bootstrap, specially in
  desktop, and can be used indenpendently, not need to be nested inside a <code>.container</code>
  .{' '}
</p>
...
- The <strong>default</strong> --gap is <strong>--size-16</strong> for mobile, <strong>--size-24</strong> for desktop
...
<div className="grid-3">
  <div className="docs-item align-self-start">This is some content with align-self</div>
  <div className="docs-item">
    This is some content. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tempor, lacus
    vel consequat viverra, tellus orci aliquet ante, sed lacinia orci orci in dui. Pellentesque
    pellentesque ultricies ex, ut faucibus orci finibus non. Phasellus blandit laoreet eros, eget
...
<div className="grid-3">
  <div className="docs-item align-self-center">This is some content with align-self</div>
  <div className="docs-item">
    This is some content. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tempor, lacus
    vel consequat viverra, tellus orci aliquet ante, sed lacinia orci orci in dui. Pellentesque
    pellentesque ultricies ex, ut faucibus orci finibus non. Phasellus blandit laoreet eros, eget
...
<div className="grid-3">
  <div className="docs-item align-self-end">This is some content with align-self</div>
  <div className="docs-item">
    This is some content. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tempor, lacus
    vel consequat viverra, tellus orci aliquet ante, sed lacinia orci orci in dui. Pellentesque
    pellentesque ultricies ex, ut faucibus orci finibus non. Phasellus blandit laoreet eros, eget
...
<div className="grid-3">
  <div className="docs-item justify-self-start">This is some content with justify-self</div>
  <div className="docs-item">
    This is some content. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tempor, lacus
    vel consequat viverra, tellus orci aliquet ante, sed lacinia orci orci in dui. Pellentesque
    pellentesque ultricies ex, ut faucibus orci finibus non. Phasellus blandit laoreet eros, eget
...
<div className="grid-3">
  <div className="docs-item justify-self-center">This is some content with justify-self</div>
  <div className="docs-item">
    This is some content. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tempor, lacus
    vel consequat viverra, tellus orci aliquet ante, sed lacinia orci orci in dui. Pellentesque
    pellentesque ultricies ex, ut faucibus orci finibus non. Phasellus blandit laoreet eros, eget
...
<div className="grid-3">
  <div className="docs-item justify-self-end">This is some content with justify-self</div>
  <div className="docs-item">
    This is some content. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed tempor, lacus
    vel consequat viverra, tellus orci aliquet ante, sed lacinia orci orci in dui. Pellentesque
    pellentesque ultricies ex, ut faucibus orci finibus non. Phasellus blandit laoreet eros, eget
