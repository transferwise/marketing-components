...
const MitsuiTrustElement = ({ title, linkText, href, useIllustration, ...rest }) => (
  <TrustElement
    {...rest}
    src="https://wise.com/public-resources/assets/marketing-components/illustrations/mitsui.svg"
    title={title}
    linkText={linkText}
    href={href}
